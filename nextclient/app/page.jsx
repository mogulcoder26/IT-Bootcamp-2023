  ...
  return (
    <>
      <div className="justify-center">
        <h1 className="mt-1 p-2 bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text text-3xl font-bold tracking-tighter text-transparent sm:text-5xl lg:text-5xl flex justify-center text-center">
        ...
        <motion.h1
          ...
          className="mt-2 mb-2 p-2 bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text text-3xl font-semibold tracking-tighter text-transparent sm:text-5xl lg:text-5xl flex justify-center"
        >
          Moments
        </motion.h1>
        <div className="flex justify-center mb-10">
            <iframe
                width="880"
                height="500"
                src="https://www.youtube.com/embed/MN3vRHcDmUA"
